...
class Service(object):
    ...
    def embarked_nominal(this) -> object:
        this.train = this.train.fillna({'Embarked', 'S'})   # S 는 사우스햄튼
        this.test = this.test.fillna({'Embarked', 'S'})   # S 는 사우스햄튼
    ...
    def fare_ordinal(this) -> object:
        ...
        this.test['FareBand'] = pd.qcut(this.test['Fare'], 4, labels={1,2,3,4})   #최고와 최저를 통해 4등분하라
